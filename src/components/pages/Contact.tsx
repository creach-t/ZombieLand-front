  ...
  return (
    <div className="main-container mt-40">
      ...
      <div className="md:grid md:grid-cols-2 md:items-center">
        ...
        />
        <form action="#" className="m-8 col-start-1 row-start-1">
          <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              name="message"
              id="message"
              className="w-full text-3xl border-white border-2 rounded-xl p-2 text-center h-60 resize-none"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-greenZombie text-black text-3xl border-white border-2 rounded-xl"
          >
            Envoyer
          </button>
        </form>
