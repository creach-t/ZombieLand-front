function Footer() {
  return (
    <footer className="md:flex flex-wrap justify-between p-4 pb-0 w-screen bg-black">
      ...
      <div className="sm:w-1/2 md:w-1/6 ">
        <h3 className="leaguegothic text-2xl uppercase">
          Liens <span className="text-redZombie">utiles</span>
        </h3>
        <ul>
          <li>
            <a className="text-white" href="/leparc">
              Le Parc
            </a>
          </li>
          <li>
            <a className="text-white" href="/attractions">
              Attractions
            </a>
          </li>
          <li>
            <a className="text-white" href="/reservations">
              Réservations
            </a>
          </li>
          <li>
            <a className="text-white" href="/connection">
              Se connecter
            </a>
          </li>
        </ul>
      ...
      <div className="w-1/6">
        ...
        <ul>
          <li className="flex gap-2">
            ...
            <a className="text-white" href="tel:+330666666666">
              +33 0666 666 666
            </a>
          </li>
          <li className="flex gap-2">
