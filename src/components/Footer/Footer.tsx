function Footer() {
  return (
    <footer className="md:flex flex-wrap justify-around p-4 w-screen bg-black">
      <div className="w-1/4">
        <h3 className="badgrunge text-2xl">ZombieLand</h3>
        <p className=" pr-4">
      ...
      <div className="w-1/4">
        <h3 className="leaguegothic text-2xl">
